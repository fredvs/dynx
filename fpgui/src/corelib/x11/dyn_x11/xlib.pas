...
var XCreateImage: function(para1:PDisplay; para2:PVisual; para3:cuint; para4:cint; para5:cint;
           para6:Pchar; para7:cuint; para8:cuint; para9:cint; para10:cint):PXImage;cdecl;
...
var XGetSubImage: function(para1:PDisplay; para2:TDrawable; para3:cint; para4:cint; para5:cuint;
           para6:cuint; para7:culong; para8:cint; para9:PXImage; para10:cint;
           para11:cint):PXImage;cdecl;
...
var XCreatePixmapCursor: function(ADisplay:PDisplay; ASource:TPixmap; AMask:TPixmap; AForegroundColor:PXColor; ABackgroundColor:PXColor;
           AX:cuint; AY:cuint):TCursor;cdecl;
var XCreateGlyphCursor: function(ADisplay:PDisplay; ASourceFont:TFont; AMaskFont:TFont; ASourceChar:cuint; AMaskChar:cuint;
           AForegroundColor:PXColor; ABackgroundColor:PXColor):TCursor;cdecl;
...
var XCreatePixmapFromBitmapData: function(para1:PDisplay; para2:TDrawable; para3:Pchar; para4:cuint; para5:cuint;
           para6:culong; para7:culong; para8:cuint):TPixmap;cdecl;
var XCreateSimpleWindow: function(ADisplay:PDisplay; AParent:TWindow; AX:cint; AY:cint; AWidth:cuint;
...
var XCreateWindow: function(ADisplay:PDisplay; AParent:TWindow; AX:cint; AY:cint; AWidth:cuint;
...
var XAllocColorCells: function(para1:PDisplay; para2:TColormap; para3:TBool; para4:Pculong; para5:cuint;
           para6:Pculong; para7:cuint):TStatus;cdecl;
var XAllocColorPlanes: function(para1:PDisplay; para2:TColormap; para3:TBool; para4:Pculong; para5:cint;
           para6:cint; para7:cint; para8:cint; para9:Pculong; para10:Pculong;
           para11:Pculong):TStatus;cdecl;
...
var XClearArea: function(para1:PDisplay; para2:TWindow; para3:cint; para4:cint; para5:cuint;
           para6:cuint; para7:TBool):cint;cdecl;
...
var XConvertSelection: function(para1:PDisplay; para2:TAtom; para3:TAtom; para4:TAtom; para5:TWindow;
           para6:TTime):cint;cdecl;
var XCopyArea: function(para1:PDisplay; para2:TDrawable; para3:TDrawable; para4:TGC; para5:cint;
           para6:cint; para7:cuint; para8:cuint; para9:cint; para10:cint):cint;cdecl;
var XCopyGC: function(para1:PDisplay; para2:TGC; para3:culong; para4:TGC):cint;cdecl;
var XCopyPlane: function(para1:PDisplay; para2:TDrawable; para3:TDrawable; para4:TGC; para5:cint;
           para6:cint; para7:cuint; para8:cuint; para9:cint; para10:cint;
           para11:culong):cint;cdecl;
...
var XDrawArc: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:cuint; para7:cuint; para8:cint; para9:cint):cint;cdecl;
var XDrawArcs: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:PXArc; para5:cint):cint;cdecl;
var XDrawImageString: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:Pchar; para7:cint):cint;cdecl;
var XDrawImageString16: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:PXChar2b; para7:cint):cint;cdecl;
var XDrawLine: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:cint; para7:cint):cint;cdecl;
var XDrawLines: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:PXPoint; para5:cint;
           para6:cint):cint;cdecl;
var XDrawPoint: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint):cint;cdecl;
var XDrawPoints: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:PXPoint; para5:cint;
           para6:cint):cint;cdecl;
var XDrawRectangle: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:cuint; para7:cuint):cint;cdecl;
...
var XDrawString: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:Pchar; para7:cint):cint;cdecl;
var XDrawString16: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:PXChar2b; para7:cint):cint;cdecl;
var XDrawText: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:PXTextItem; para7:cint):cint;cdecl;
var XDrawText16: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:PXTextItem16; para7:cint):cint;cdecl;
...
var XFillArc: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:cuint; para7:cuint; para8:cint; para9:cint):cint;cdecl;
var XFillArcs: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:PXArc; para5:cint):cint;cdecl;
var XFillPolygon: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:PXPoint; para5:cint;
           para6:cint; para7:cint):cint;cdecl;
var XFillRectangle: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
           para6:cuint; para7:cuint):cint;cdecl;
...
var XGeometry: function(para1:PDisplay; para2:cint; para3:Pchar; para4:Pchar; para5:cuint;
           para6:cuint; para7:cuint; para8:cint; para9:cint; para10:Pcint;
           para11:Pcint; para12:Pcint; para13:Pcint):cint;cdecl;
var XGetErrorDatabaseText: function(para1:PDisplay; para2:Pchar; para3:Pchar; para4:Pchar; para5:Pchar;
           para6:cint):cint;cdecl;
...
var XGetGeometry: function(para1:PDisplay; para2:TDrawable; para3:PWindow; para4:Pcint; para5:Pcint;
           para6:Pcuint; para7:Pcuint; para8:Pcuint; para9:Pcuint):TStatus;cdecl;
...
var XGrabKey: function(para1:PDisplay; para2:cint; para3:cuint; para4:TWindow; para5:TBool;
           para6:cint; para7:cint):cint;cdecl;
var XGrabKeyboard: function(para1:PDisplay; para2:TWindow; para3:TBool; para4:cint; para5:cint;
           para6:TTime):cint;cdecl;
var XGrabPointer: function(para1:PDisplay; para2:TWindow; para3:TBool; para4:cuint; para5:cint;
           para6:cint; para7:TWindow; para8:TCursor; para9:TTime):cint;cdecl;
...
var XMoveResizeWindow: function(ADisplay:PDisplay; AWindow:TWindow; AX:cint; AY:cint; AWidth:cuint;
           AHeight:cuint):cint;cdecl;
...
var XPutImage: function(para1:PDisplay; para2:TDrawable; para3:TGC; para4:PXImage; para5:cint;
           para6:cint; para7:cint; para8:cint; para9:cuint; para10:cuint):cint;cdecl;
var XQLength: function(para1:PDisplay):cint;cdecl;
var XQueryBestCursor: function(para1:PDisplay; para2:TDrawable; para3:cuint; para4:cuint; para5:Pcuint;
           para6:Pcuint):TStatus;cdecl;
var XQueryBestSize: function(para1:PDisplay; para2:cint; para3:TDrawable; para4:cuint; para5:cuint;
           para6:Pcuint; para7:Pcuint):TStatus;cdecl;
var XQueryBestStipple: function(para1:PDisplay; para2:TDrawable; para3:cuint; para4:cuint; para5:Pcuint;
           para6:Pcuint):TStatus;cdecl;
var XQueryBestTile: function(para1:PDisplay; para2:TDrawable; para3:cuint; para4:cuint; para5:Pcuint;
           para6:Pcuint):TStatus;cdecl;
...
var XQueryPointer: function(para1:PDisplay; para2:TWindow; para3:PWindow; para4:PWindow; para5:Pcint;
           para6:Pcint; para7:Pcint; para8:Pcint; para9:Pcuint):TBoolResult;cdecl;
var XQueryTextExtents: function(para1:PDisplay; para2:TXID; para3:Pchar; para4:cint; para5:Pcint;
           para6:Pcint; para7:Pcint; para8:PXCharStruct):cint;cdecl;
var XQueryTextExtents16: function(para1:PDisplay; para2:TXID; para3:PXChar2b; para4:cint; para5:Pcint;
           para6:Pcint; para7:Pcint; para8:PXCharStruct):cint;cdecl;
var XQueryTree: function(para1:PDisplay; para2:TWindow; para3:PWindow; para4:PWindow; para5:PPWindow;
           para6:Pcuint):TStatus;cdecl;
var XRaiseWindow: function(para1:PDisplay; para2:TWindow):cint;cdecl;
var XReadBitmapFile: function(para1:PDisplay; para2:TDrawable; para3:Pchar; para4:Pcuint; para5:Pcuint;
           para6:PPixmap; para7:Pcint; para8:Pcint):cint;cdecl;
var XReadBitmapFileData: function(para1:Pchar; para2:Pcuint; para3:Pcuint; para4:PPcuchar; para5:Pcint;
           para6:Pcint):cint;cdecl;
var XRebindKeysym: function(para1:PDisplay; para2:TKeySym; para3:PKeySym; para4:cint; para5:Pcuchar;
           para6:cint):cint;cdecl;
...
var XSetClipRectangles: function(para1:PDisplay; para2:TGC; para3:cint; para4:cint; para5:PXRectangle;
           para6:cint; para7:cint):cint;cdecl;
...
var XSetLineAttributes: function(para1:PDisplay; para2:TGC; para3:cuint; para4:cint; para5:cint;
           para6:cint):cint;cdecl;
...
var XSetState: function(para1:PDisplay; para2:TGC; para3:culong; para4:culong; para5:cint;
           para6:culong):cint;cdecl;
...
var XTextExtents: function(para1:PXFontStruct; para2:Pchar; para3:cint; para4:Pcint; para5:Pcint;
           para6:Pcint; para7:PXCharStruct):cint;cdecl;
var XTextExtents16: function(para1:PXFontStruct; para2:PXChar2b; para3:cint; para4:Pcint; para5:Pcint;
           para6:Pcint; para7:PXCharStruct):cint;cdecl;
...
var XTranslateCoordinates: function(ADisplay:PDisplay; ASrcWindow:TWindow; ADestWindow:TWindow; ASrcX:cint; ASrcY:cint;
           ADestXReturn:Pcint; ADestYReturn:Pcint; AChildReturn:PWindow):TBool;cdecl;
...
var XWarpPointer: function(para1:PDisplay; para2:TWindow; para3:TWindow; para4:cint; para5:cint;
           para6:cuint; para7:cuint; para8:cint; para9:cint):cint;cdecl;
...
var XWriteBitmapFile: function(para1:PDisplay; para2:Pchar; para3:TPixmap; para4:cuint; para5:cuint;
           para6:cint; para7:cint):cint;cdecl;
...
var XmbTextPerCharExtents: function(para1:TXFontSet; para2:Pchar; para3:cint; para4:PXRectangle; para5:PXRectangle;
           para6:cint; para7:Pcint; para8:PXRectangle; para9:PXRectangle):TStatus;cdecl;
var XwcTextPerCharExtents: function(para1:TXFontSet; para2:PWideChar; para3:cint; para4:PXRectangle; para5:PXRectangle;
           para6:cint; para7:Pcint; para8:PXRectangle; para9:PXRectangle):TStatus;cdecl;
var Xutf8TextPerCharExtents: function(para1:TXFontSet; para2:Pchar; para3:cint; para4:PXRectangle; para5:PXRectangle;
           para6:cint; para7:Pcint; para8:PXRectangle; para9:PXRectangle):TStatus;cdecl;
var XmbDrawText: procedure(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
            para6:PXmbTextItem; para7:cint);cdecl;
var XwcDrawText: procedure(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
            para6:PXwcTextItem; para7:cint);cdecl;
var Xutf8DrawText: procedure(para1:PDisplay; para2:TDrawable; para3:TGC; para4:cint; para5:cint;
            para6:PXmbTextItem; para7:cint);cdecl;
var XmbDrawString: procedure(para1:PDisplay; para2:TDrawable; para3:TXFontSet; para4:TGC; para5:cint;
            para6:cint; para7:Pchar; para8:cint);cdecl;
var XwcDrawString: procedure(para1:PDisplay; para2:TDrawable; para3:TXFontSet; para4:TGC; para5:cint;
            para6:cint; para7:PWideChar; para8:cint);cdecl;
var Xutf8DrawString: procedure(para1:PDisplay; para2:TDrawable; para3:TXFontSet; para4:TGC; para5:cint;
            para6:cint; para7:Pchar; para8:cint);cdecl;
var XmbDrawImageString: procedure(para1:PDisplay; para2:TDrawable; para3:TXFontSet; para4:TGC; para5:cint;
            para6:cint; para7:Pchar; para8:cint);cdecl;
var XwcDrawImageString: procedure(para1:PDisplay; para2:TDrawable; para3:TXFontSet; para4:TGC; para5:cint;
            para6:cint; para7:PWideChar; para8:cint);cdecl;
var Xutf8DrawImageString: procedure(para1:PDisplay; para2:TDrawable; para3:TXFontSet; para4:TGC; para5:cint;
            para6:cint; para7:Pchar; para8:cint);cdecl;
...
var Xutf8LookupString: function(para1:PXIC; para2:PXKeyPressedEvent; para3:Pchar; para4:cint; para5:PKeySym;
           para6:PStatus):cint;cdecl;
var XVaCreateNestedList: function(unused:cint; dotdotdot:array of const):TXVaNestedList;cdecl;
var XRegisterIMInstantiateCallback: function(para1:PDisplay; para2:PXrmHashBucketRec; para3:Pchar; para4:Pchar; para5:TXIDProc;
           para6:TXPointer):TBoolResult;cdecl;
var XUnregisterIMInstantiateCallback: function(para1:PDisplay; para2:PXrmHashBucketRec; para3:Pchar; para4:Pchar; para5:TXIDProc;
           para6:TXPointer):TBoolResult;cdecl;
type
...
// var XdbeQueryExtension: function(ADisplay: PXDisplay; AMajor, AMinor: PInt): PStatus; cdecl;
// var XdbeAllocateBackBufferName: function(ADisplay: PXDisplay; AWindow: TfpgWinHandle; ASwapAction: PChar): TfpgWinHandle; cdecl;  
//var XdbeSwapBuffers: function(ADisplay: PXDisplay; ASwapInfo: PXdbeSwapInfo; AScreenNums: integer): PStatus; cdecl; 
//var XdbeDeallocateBackBufferName: function(ADisplay: PXDisplay; ABuffer: TfpgWinHandle): PStatus; cdecl;
...
var XSetStandardProperties: function(para1:PDisplay; para2:TWindow; para3:Pchar; para4:Pchar; para5:TPixmap;
           para6:PPchar; para7:cint; para8:PXSizeHints):cint;cdecl;
...
var XSetWMProperties: procedure(ADisplay:PDisplay; AWindow:TWindow; AWindowName:PXTextProperty; AIconName:PXTextProperty; AArgv:PPchar;
            AArgc:cint; ANormalHints:PXSizeHints; AWMHints:PXWMHints; AClassHints:PXClassHint);cdecl;
var XmbSetWMProperties: procedure(para1:PDisplay; para2:TWindow; para3:Pchar; para4:Pchar; para5:PPchar;
            para6:cint; para7:PXSizeHints; para8:PXWMHints; para9:PXClassHint);cdecl;
var Xutf8SetWMProperties: procedure(para1:PDisplay; para2:TWindow; para3:Pchar; para4:Pchar; para5:PPchar;
            para6:cint; para7:PXSizeHints; para8:PXWMHints; para9:PXClassHint);cdecl;
...
var XWMGeometry: function(para1:PDisplay; para2:cint; para3:Pchar; para4:Pchar; para5:cuint;
...
begin {now we tie the functions to the VARs from above}
 ...
 Pointer(XRenderQueryExtension):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderQueryExtension'));
 Pointer(XRenderQueryVersion):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderQueryVersion'));
 Pointer(XRenderQueryFormats):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderQueryFormats'));
 Pointer(XRenderFindVisualFormat):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderFindVisualFormat'));
 Pointer(XRenderFindFormat):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderFindFormat'));
 Pointer(XRenderCreatePicture):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderCreatePicture'));
 Pointer(XRenderChangePicture):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderChangePicture'));
 Pointer(XRenderFreePicture):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderFreePicture'));
 Pointer(XRenderComposite):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderComposite'));
 Pointer(XRenderCreateGlyphSet):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderCreateGlyphSet'));
 Pointer(XRenderReferenceGlyphSet):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderReferenceGlyphSet'));
 Pointer(XRenderFreeGlyphSet):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderFreeGlyphSet'));
 Pointer(XRenderAddGlyphs):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderAddGlyphs'));
 Pointer(XRenderFreeGlyphs):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderFreeGlyphs'));
 Pointer(XRenderCompositeString8):=DynLibs.GetProcedureAddress(x_Handle,PChar('XRenderCompositeString8'));
 ...
 // Pointer(XdbeQueryExtension):=DynLibs.GetProcedureAddress(x_Handle,PChar('XdbeQueryExtension'));
 // Pointer(XdbeAllocateBackBufferName):=DynLibs.GetProcedureAddress(x_Handle,PChar('XdbeAllocateBackBufferName'));
 // Pointer(XdbeDeallocateBackBufferName):=DynLibs.GetProcedureAddress(x_Handle,PChar('XdbeDeallocateBackBufferName'));
 // Pointer(XdbeSwapBuffers):=DynLibs.GetProcedureAddress(x_Handle,PChar('XdbeSwapBuffers'));
